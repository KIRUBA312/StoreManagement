...
import com.inn.store.POJO.Product;
...
import com.inn.store.wrapper.ProductWrapper;
				...
				if(validateProductMap(requestMap,true)) {
					...
					if(!optional.isEmpty()) {
						...
						return storeUtils.getResponseEntity("Product Updated Successfully",HttpStatus.OK);
							...
							return storeUtils.getResponseEntity("Product id does not exis",HttpStatus.OK);
						}
				}
				else {
					return  storeUtils.getResponseEntity(storeConstants.INVALID_DATA,HttpStatus.BAD_REQUEST);
